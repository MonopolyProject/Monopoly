...
namespace Monopoly
{
    public class PropertyInitializer
    {
        ...
        public static List<Cell> populateCells(Player banker)
        {
            ...
            mediterr.setColorHouses(new Property[] { baltic });
            baltic.setColorHouses(new Property[] { mediterr });
            ...
            oriental.setColorHouses(new Property[] { vermont, connecticut });
            vermont.setColorHouses(new Property[] { oriental, connecticut });
            connecticut.setColorHouses(new Property[] { vermont, oriental });
            ...
            charles.setColorHouses(new Property[] { virginia, states });
            states.setColorHouses(new Property[] { charles, connecticut });
            virginia.setColorHouses(new Property[] { charles, states });
            ...
            james.setColorHouses(new Property[] { newyork, tennessee });
            tennessee.setColorHouses(new Property[] { james, newyork });
            newyork.setColorHouses(new Property[] { james, tennessee });
            ...
            kentucky.setColorHouses(new Property[] { illinois, indiana });
            indiana.setColorHouses(new Property[] { kentucky, illinois });
            illinois.setColorHouses(new Property[] { kentucky, indiana });
            ...
            atlantic.setColorHouses(new Property[] { ventnor, marvin });
            ventnor.setColorHouses(new Property[] { atlantic, marvin });
            marvin.setColorHouses(new Property[] { atlantic, ventnor });
            ...
            pacific.setColorHouses(new Property[] { carolina, penn });
            carolina.setColorHouses(new Property[] { pacific, penn });
            penn.setColorHouses(new Property[] { pacific, carolina });
            ...
            park.setColorHouses(new Property[] { boardwalk });
            boardwalk.setColorHouses(new Property[] { park });
